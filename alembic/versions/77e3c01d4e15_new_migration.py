...
Revision ID: 77e3c01d4e15
Revises: 
Create Date: 2025-09-01 09:57:57.920953
...
def upgrade() -> None:
    ...
    sa.Column('type', sa.Enum('COUNTABLE', 'UNCOUNTABLE', name='itemtype'), nullable=False),
    sa.Column('karat_default', sa.BigInteger(), nullable=False),
    sa.Column('ojrat_default', sa.BigInteger(), nullable=False),
    sa.Column('profit_default', sa.BigInteger(), nullable=False),
    sa.Column('tax_default', sa.BigInteger(), nullable=False),
    ...
    sa.Column('name', sa.Enum('CONTACT_READ_ALL', 'CONTACT_UPDATE_ALL', 'CONTACT_SEARCH', 'USER_CREATE', 'USER_READ_ALL', 'USER_UPDATE', 'USER_DELETE', name='permissionname'), nullable=False),
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=True),
    sa.PrimaryKeyConstraint('id')
